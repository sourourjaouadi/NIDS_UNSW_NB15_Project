          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-300">
                Drag packet captures directly into the platform or browse from disk. The interface simulates secure
                ingestion, validation, and flow extraction with polished analyst feedback.
              </p>
            </div>
          ...
          >
            ...
            <div className="mx-auto flex max-w-xl flex-col items-center text-center">
              ...
              <p className="mt-3 max-w-md text-sm leading-7 text-slate-400">
                Mobile-friendly upload surface with simulated validation, progress tracking, and file-ready feedback.
              </p>
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                ...
                <span className="rounded-full border border-white/10 bg-white/5 px-4 py-3 text-sm text-slate-300">
                  Secure upload window - Max 100 MB
                </span>
              </div>
            </div>
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        ...
                        <div className={`flex items-center gap-2 text-xs font-semibold ${statusMap[file.status].className}`}>
                          <StatusIcon className={`h-4 w-4 ${file.status !== "ready" ? "animate-spin" : ""}`} />
